...
void print_usage() {
    std::cerr
        ...
        << " [--config <path>]\n\n"
        << "Example:\n"
        << "  fridge_cloud_classifier_demo --image python/cloud_classifier/examples/apple_crop.ppm"
        << " --coarse-class fruit --candidates apple,orange,lemon --config configs/cloud_classifier.json\n";
}
...
int main(int argc, char** argv) {
    try {
        ...
        std::filesystem::path config_path = "configs/cloud_classifier.json";
